...
def bayes_drt_save(loc_eis:str,fit_path:str,fit_name:str):
    '''
...
def map_drt_save(loc_eis:str,fit_path:str,fit_name:str,which:bool='core',init_from_ridge:bool=True,outliers:bool=False):
    '''
